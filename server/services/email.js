...
const keysDeep = require('@strapi/utils').keysDeep;
const createStrictInterpolationRegExp = require('@strapi/utils').template.createStrictInterpolationRegExp;
...
module.exports = ({ strapi }) => {
  const templater = (tmpl, data) => {
    ...
    return _.template(tmpl, { interpolate, evaluate: false, escape: false });
  };
